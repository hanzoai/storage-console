  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        with Hanzo Space source code or at{" "}
        {makeLink(
      ...
      <p>
        When you host or distribute Hanzo Space over a network, the AGPL v3 applies to
        you. Any distribution or copying of Hanzo Space software modified or not has
      ...
      <h2>Making combined or derivative works of Hanzo Space</h2>
      <p>
        Creating combined or derivative works of Hanzo Space requires all such works
        to be released under the same license.
      </p>
      <p>
        If Hanzo Space source code is included in the same executable file, they are
      ...
      <p>
        Merely aggregating Hanzo Space software into your distribution does not
      ...
      <p>
        ...
        for legal advice. Purchasing a commercial license removes the
        GNU AGPL v3 obligations from Hanzo Space software.
      </p>
    </Fragment>
  );
};
